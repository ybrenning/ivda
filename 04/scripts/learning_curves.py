...
if __name__ == "__main__":
    ...
    np.save('train_abs_1.npy', train_size_abs)
    np.save('train_1.npy', train_scores)
    np.save('test_1.npy', test_scores)
    train_size_abs, train_scores, test_scores = learning_curve(mlp2, X_scaled, y, train_sizes=np.linspace(0.1, 1.0, 10))
    np.save('train_abs_2.npy', train_size_abs)
    np.save('train_2.npy', train_scores)
    np.save('test_2.npy', test_scores)
